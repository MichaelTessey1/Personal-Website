      ...
      <div className = "about-wrap">
        ...
        <div className = "tools">
          ...
          <div className="tools-icons-container">
            <img src="https://cdn-icons-png.flaticon.com/512/1051/1051277.png" className="tools-icon" />
            <img src="https://cdn-icons-png.flaticon.com/512/732/732190.png" className="tools-icon" />
            <img src="https://cdn-icons-png.flaticon.com/512/5968/5968292.png" className="tools-icon" />
            <img src="https://cdn-icons-png.flaticon.com/512/7439/7439488.png" className="tools-icon" />
            <img src="https://cdn-icons-png.flaticon.com/512/919/919825.png" className="tools-icon" />
            <img src="https://raw.githubusercontent.com/reduxjs/redux/master/logo/logo.png" className="tools-icon" />
            <img src="https://cdn-icons-png.flaticon.com/512/5968/5968342.png" className="tools-icon" />
            <img src="https://cdn-icons-png.flaticon.com/512/4494/4494749.png" className="tools-icon" />
            <img src="https://cdn-icons-png.flaticon.com/512/5968/5968350.png" className="tools-icon" />
            <img src="https://user-images.githubusercontent.com/7853266/44114706-9c72dd08-9fd1-11e8-8d9d-6d9d651c75ad.png" className="tools-icon" />
            <img src="https://cdn-icons-png.flaticon.com/512/873/873120.png" className="tools-icon" />
            <img src="https://cdn-icons-png.flaticon.com/512/9307/9307630.png" className="tools-icon" />
          </div>
        </div> 
